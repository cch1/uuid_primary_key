...
# MIT License
# Derived from the works of several others, including Demetrio Nunes, Paul Dix
# and Lee Jensen.
#
# Requirements: UUIDTools GEM
# 
# Place file in /lib directory and 'require' it in environemnts.rb.  Then, in 
# any model class requiring a UUID PK, invoke UUIDPrimaryKey, optionally with 
# the name of the PK column in your database.
# 
# Hints:
...
#        super
#        self.id = params[:uuid] if !params[:uuid].nil? and UUID.parse(params[:uuid]).valid?
#      end
#    end
#   
